...
class Analyzer(AnalyzerBase):
    ...
    def __init__(self, mem=4, pw=None, port=VIRTUOSO_PORT, all_roots=False, all_sps=False):
...
def main():
    ...
    a.analyze_dir(args.proj_dir, proj_id=args.proj, keep_fb=args.keep_fb, cleanup=True)
